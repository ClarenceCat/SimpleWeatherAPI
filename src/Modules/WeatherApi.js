...
const getWeather = async (cityName) => {
    ...
    const api_call_str = `api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=${process.env.WEATHER_API_KEY}`;
    ...
    try{
        ...
        logger.info(`Making GET request to the OpenWeather API (@openweathermap.org) with the city name ${city}`);
